function ExpRes = func_opt_gap_eff(CL,ENV)
...
k0_his = 1;   % k0_his selects different battery power variance, k0_his = 1 reprents the least variance
k2_his = 1;   % k2_his loop selects the specific battery stat vectors 
...
%           bat_power_rating(k0,k1,k2,:) = ExpRes.bat_power_rating(k0_his,k1,k2_his,:);
            ...
            OptRes = func_dc_powerflow_opt_gap(ExpRes.avg_power_flow(k0_his,k1,k2_his), ExpRes.var_power_flow(k0_his,k1,k2_his),...
                Bat_info, CL, ENV);
