function y = func_plot_task_lsv_5_2(CL,ENV,ExpRes,ENV_trad,ExpRes_trad,ENV_fpp,ExpRes_fpp)
...
%             legend([pic(i),pic_trad(i),pic_fpp(i)],'LSV-PPP','LS-HiPPP','Full Processing','Fontsize',10);
%             grid on;
%             grid minor;
%         end
...
%             legend([pic_25,pic_trad_25,pic_fpp_25],'LSV-PPP','LS-HiPPP','Full Processing','Fontsize',10,'Location',[0.3,0.25,0.3,0.1]);
%             grid on;
%             grid minor;
%         end
%         ylim([70 100]);
...
%             ylabel('System Energy Efficiency (%)');
%             title('Battery Capacity Variation 25%','Fontsize',9);
%             legend([pic_25,pic_trad_25,pic_fpp_25],'LSV-PPP','LS-HiPPP','Full Processing','Fontsize',10);
%             grid on;
%             grid minor;
%         end    
% 
